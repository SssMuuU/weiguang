...
export default function WindowsDownload() {
  return <main className="info-page"><article className="info-card glass-panel">
    ...
    <section>
      ...
      <p>先关闭微光，运行下载的 MSI，等待进度完成即可，<strong>无需卸载旧版</strong>。结束后从桌面快捷方式打开微光。建议升级前导出一份备份。</p>
    ...
    <section><h2>之后如何更新</h2><p>窗口底部可检查并下载新版。下载通过校验后，微光会关闭并显示简洁的安装进度，由系统完成升级和回退；更新完成后会自动重新打开。</p></section>
